        ...
        writerQueue.async { [weak self] in
            ...
            if writer.status == .writing && input.isReadyForMoreMediaData && self.hasStartedSession {
                if !adaptor.append(imageBuffer, withPresentationTime: pts) {
                    print("SampleHandler: Failed to append pixel buffer: \(String(describing: writer.error))")
                }
            } else if writer.status == .failed {
                print("SampleHandler: AVAssetWriter failed: \(String(describing: writer.error))")
            }
        }
    }
