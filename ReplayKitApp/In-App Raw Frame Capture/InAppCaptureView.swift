    ...
    public var body: some View {
        VStack(spacing: 24) {
            ...
            ScrollView {
                ...
                Text("Note: This feature capture raw screen buffers and encrypt them in real time using CryptoKit AES-GCM. Using AES-GCM Encryption: The JPEG bytes are instantly encrypted with the 256-bit symmetric key generated by the Secure Enclave.")
                    .font(.footnote)
                    .multilineTextAlignment(.leading)
                    .foregroundColor(.secondary)
                    .padding(.horizontal)
