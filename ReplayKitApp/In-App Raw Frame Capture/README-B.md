...
In iOS, Option A (In-App Screen Recording) is designed to produce a local, fully finished MP4 video file.

However, in many production scenarios, you don't want a file. Instead, you need the raw video feed in real time. Option B (In-App Raw Frame Capture) is designed for these scenarios:
